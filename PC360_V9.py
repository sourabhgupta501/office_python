import time, threading, requests, pandas, re, string, datetime, easygui
...
#    list_df = split_dataframe_to_chunks(df, 8)
    ...
    df.to_csv(file_name.replace('.csv', '_output.csv'), sep=',', encoding='utf-8', index=False)
